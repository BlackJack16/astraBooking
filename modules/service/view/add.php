		...
		<div class="panel-body">
			<form class="form-horizontal" action="?m=add_save" method="post" autocomplete="off">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<input type="text" class="form-control" required name="nama" placeholder="Nama service" />
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-3 control-label"><strong>Harga <span class="required">*</span></strong></label>
					<div class="col-sm-9">
						<input type="text" class="form-control" required autofocus name="harga" placeholder="Harga" />
					</div>
				</div>
